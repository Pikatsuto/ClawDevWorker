...
| `/project select <name>` | Loads the project context |
| `/project status` | Current issues and PRs (git API) |
| `/project code` | Loads the code in read-only mode (explicit) |
| `/project memory` | Displays the project memory |
| `/project rules` | Displays the project pipeline rules |
...
specialists:
  marketing:
    triggers: [seo, landing, storefront, copy]
  design:
